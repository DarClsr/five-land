...
- 探索、普通战斗与首领镜头尺寸分别为 `7.0`、`6.2`、`7.8`，玩家略偏下并按分区路线方向前瞻。
- 序章由单一纵向通道改为“左斜断桥—横向墟门—右斜送葬道—横向封印庭院—左斜墓道—横向首领场地”。
- 地板、石板引导线、区域触发器、敌人/灯笼、镜头边界、峡谷墙、虚空边缘与碰撞共同使用新的 Z 字路线。
- 镜头前侧峡谷墙降低高度；遮住角色时按投影包围盒淡化，避免大体积前景压住行动层。
